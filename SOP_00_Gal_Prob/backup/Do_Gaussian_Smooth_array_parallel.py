...
#=========================================================================================
# Main Functions
def cal_smooth(pos, no_lack_ind, upper, lower, source, key, after_smooth):
...
for lack in lack_list:
    ...
    for i, key in enumerate(source.keys()):
        ...
        if gal_pos.count("Lack") <= (len(shape)-3):
            ...
            Parallel(n_jobs=40)(delayed(cal_smooth)(pos, no_lack_ind, upper, lower, source, key, after_smooth) for pos in beam)

...
'----------------------------------------------------------------------------------------------------'
print("Load...")
Gal_pos=load("../GPV_6bands_Condition_newlim_bin0.4/Gal_Position_vectors.npy")
...
shape=load("../GPV_6bands_Condition_newlim_bin0.4/Shape.npy")
shape=list(shape)
'----------------------------------------------------------------------------------------------------'
...
print("Saving result")
system('mkdir result_condition_newlim_0.4')
chdir('result_condition_newlim_0.4')

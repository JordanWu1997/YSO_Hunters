...
if len(Pass) != 0:
    ...
    system('Deg_To_WCS.py ' + cloud + '_YSOc_PASS_test_6D_GP_to_image_check.tbl ' + cloud + ' Image_Check')
    system('Get_Fits.py ' + cloud + '_cans_to_wcs_image_check.tbl ' + cloud + ' Image_Check')
    system('echo | awk \'$185 == \"S\" \' '+ cloud + '_YSOc_PASS_test_6D_YSO.tbl' + ' > ' + cloud + '_saturate_candidates.tbl')
    system('Deg_To_WCS.py ' + cloud + '_saturate_candidates.tbl ' + cloud + ' Saturate')
    system('Get_Fits.py ' + cloud + '_cans_to_wcs_saturate.tbl ' + cloud + ' Saturate')
    system('echo | awk \'$185 != \"S\" \' '+ cloud + '_YSOc_PASS_test_6D_YSO.tbl' + ' > ' + cloud + '_YSO_candidates.tbl')
    system('Deg_To_WCS.py ' + cloud + '_YSO_candidates.tbl ' + cloud + ' IR1_Check')
    system('Get_Fits.py ' + cloud + '_cans_to_wcs_IR1_check.tbl ' + cloud + ' IR1_Check')
...
# (2) Get Image
system('Deg_To_WCS.py ' + cloud + '_YSOc_FAIL_test_6D_GP_to_image_check.tbl ' + cloud + ' Image_Check')
system('Get_Fits.py ' + cloud + '_cans_to_wcs_image_check.tbl ' + cloud + ' Image_Check')

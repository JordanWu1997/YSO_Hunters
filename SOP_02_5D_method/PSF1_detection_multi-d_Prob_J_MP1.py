...
# path="/cosmo/users/inchone/Remove_Av_sources_in_whole_clouds/SWI_c2d_PSD_new_process2_multi-dim_version/J_MP1_plus_IR1_MP1_methed/c2d_SWIRE_J-MP1/"

path = spp.Hsieh_5D_GP1_Array_path
print "Loading array"
...
band_name=['J','Ks','IR2','IR4','MP1']
def magnitudelist(x):
#        flux_list=[float(x[96]),float(x[117]),float(x[138]),float(x[159]),float(x[180])]
	flux_list=[float(x[33]),float(x[75]),float(x[96]),float(x[117]),float(x[138]),float(x[159]),float(x[180])]
...
#        flux_Qua=[x[100],x[121],x[142],x[163],x[184]]
	flux_Qua=[x[37],x[79],x[100],x[121],x[142],x[163],x[184]]
	PSF_list=[x[39],x[81],x[102],x[123],x[144],x[165],x[186]]
        mag_list=[]
...
#	PSF_list=[line[102],line[123],line[144],line[165],line[186]]
	PSF_list=[line[39],line[81],line[123],line[165],line[186]]
#calculate
#	SEQ=[seq(magIR1,IR1axlim),seq(magIR2,IR2axlim),seq(magIR3,IR3axlim),seq(magIR4,IR4axlim),seq(magMP1,MP1axlim)]
	SEQ=[seq(magJ,Jaxlim),seq(magKs,Ksaxlim),seq(magIR2,IR2axlim),seq(magIR4,IR4axlim),seq(magMP1,MP1axlim)]

...
if len(argv) != 3:
    ...
    print('Exmaple: Gal_Prob_Execution.py [catalog] [MC cloud]')
    exit()
...
os.system('Check_Prob.py ' + 'catalog-' + str(cloud) + '_Gal_Prob_All.tbl' + ' ' + str(cloud))
